...
% move red arrow to be first in both arrays
% yellowCentroids = [yellowCentroids(start_arrow_id, :); yellowCentroids(1:start_arrow_id-1, :); yellowCentroids(start_arrow_id+1:end, :)];
% propsCentroids = [propsCentroids(start_arrow_id, :); propsCentroids(1:start_arrow_id-1, :); propsCentroids(start_arrow_id+1:end, :)];

% % Swap the selected row with the first row
% tempRow = yellowCentroids(1, :);
% yellowCentroids(1, :) = yellowCentroids(start_arrow_id, :);
% yellowCentroids(start_arrow_id, :) = tempRow;
% 
% % Reorder the remaining rows to maintain the original order
% yellowCentroids = [yellowCentroids(1, :); yellowCentroids(setdiff(1:size(yellowCentroids, 1), 1), :)];
% 
% % Display the updated array
% disp(yellowCentroids);
% 
% % Swap the selected row with the first row
% tempRow = propsCentroids(1, :);
% propsCentroids(1, :) = propsCentroids(start_arrow_id, :);
% propsCentroids(start_arrow_id, :) = tempRow;
